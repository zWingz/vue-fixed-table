...
export default {
    ...
    computed: {
        theadStyle() {
            return {
                transform: `translate3d(0px, ${this.fixed.top && !this.topChanging
              ? -this.clientRect.top
              : 0}px, 1px)`
            };
        },
        ...
        leftStyle() {
            return {
              ...
              : 0}px, 0px, 0px)`,
                width: 'initial',
                opacity: !(this.offsetLeft - this.clientRect.left > this.tleftWidth) ? 1 : this.opacity
            };
        },
        rightStyle() {
            const base = {
        ...
        // addTransitionClass() {
        //     return this.isTransition && !(this.leftChanging || this.topChanging)
        //         ? 'common-table-transition'
        //         : '';
        // },
        // addOpacityClass() {
        //     return this.opacity ? 'opacity-transition' : ''
        // }
    },
    mounted() {
    ...
    methods: {
        ...
        getPointOffsetParent() {
            ...
            let right = -this.scroller.clientWidth +
                this.tleftWidth +
        ...
        scrollHandle() {
            ...
            if(this.selfScroll) {
                ...
                const length =
                    this.tleftWidth + this.$refs.tbody.clientWidth + this.tRightWidth;
...
<style lang='scss'>
    .fixed-table-container {
      ...
      box-shadow: -1px 0px 0px 0px #dadada, 1px 0px 0px 0px #dadada,0px 1px 0 0 #dadada;
